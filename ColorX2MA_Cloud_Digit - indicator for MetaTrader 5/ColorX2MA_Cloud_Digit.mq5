...
//+-----------------------------------+
input string  SirName="ColorX2MA_Cloud_Digit";     //Первая часть имени графических объектов
...
//---- инициализации переменной для короткого имени индикатора
   ...
   StringConcatenate(shortname,"ColorX2MA_Cloud_Digit(",Length1,", ",Length2,", ",Smooth1,", ",Smooth2,")");
