...
//+------------------------------------------------+
input string  SirName="ColorJFatl_Cloud_Digit";     //Первая часть имени графических объектов
...
//---- инициализации переменной для короткого имени индикатора
   string shortname;
   StringConcatenate(shortname,"JFatl_Cloud_Digit(",JLength," ,",JPhase,")");
